...
def main(args):
    ...
    # test_ds = create_test_dataloader(1, r'D:\Codes\计算机视觉工程实践\计算机视觉实践-练习3\srgan\src\dataset\Set5\LR\2x', inference=True)
    ...
    for data in test_data_loader:
        ...
        result.save(f".\src\output\{args.scale}x\{i}.jpg")
        i += 1
